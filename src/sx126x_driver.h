...
#define SX126X_PIN_NSS                          15
#define SX126X_PIN_RESET                        -1
#define SX126X_PIN_BUSY                         16
#define SX126X_SPI                              SPI
#ifdef __AVR__
    #define SX126X_SPI_FREQUENCY                F_CPU / 2   // SPI speed set to half of CPU frequency for AVR processor
#else
    #define SX126X_SPI_FREQUENCY                2000000    // Maximum LoRa SPI frequency // it was 16000000
#endif
#define SX126X_BUSY_TIMEOUT                     500        // Default timeout for checking busy pin ; it was 5000
                                                           // to high can crash ESP8266 ( or use yield())
